...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default" href=${pageContext.request.contextPath}/product/productList?searchCondition=Instrument" />"
               role="button">
                <img class="img-circle" src="${pageContext.request.contextPath}/static/images/instrument.jpg" />" alt="Instrument
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Record" />"
               role="button">
                <img class="img-circle" src="${pageContext.request.contextPath}/static/images/record.jpg" />" alt="Instrument
                Image" width="140" height="140"></a>
    ...
    <div class="row">
        <div class="col-lg-4">
            <a class="btn btn-default" href="<c:url value="/product/productList?searchCondition=Accessory" />"
               role="button">
                <img class="img-circle" src="${pageContext.request.contextPath}/static/images/accessory.jpg" />" alt="Instrument
                Image" width="140" height="140"></a>
